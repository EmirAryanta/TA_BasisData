...
public class main extends javax.swing.JFrame {
    ...
    public void login(){
        ...
        hasil = AllObject.pegawai.login(user, pass);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(user.equals("admin")&&pass.equals("admin")){
            ...
            dispose();
        }else if(user.equals("kasir")&&pass.equals("kasir")){
            transaksi ksr = new transaksi();
            ksr.setUser(user);
            ksr.setLocationRelativeTo(null);
            ksr.setVisible(true);
            dispose();}
        else if (hasil.equalsIgnoreCase("Admin")){
            menu_admin admin = new menu_admin();
            admin.setLocationRelativeTo(null);
            admin.setVisible(true);
            dispose(); 
        }else if (hasil.equalsIgnoreCase("Kasir")){
            transaksi ksr = new transaksi();
            ksr.setUser(user);
            ksr.setLocationRelativeTo(null);
            ksr.setVisible(true);
